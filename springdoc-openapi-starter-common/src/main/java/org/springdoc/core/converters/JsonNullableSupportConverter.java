...
public class JsonNullableSupportConverter implements ModelConverter {
	...
	/**
	 * Instantiates a new JsonNullable support converter.
	 *
	 ...
	 *
	 * @param wrapper     the JsonNullable wrapper type
	 * @param annotations the context annotations
	 * @param original    the annotated type being resolved
	 * @param context     the model converter context
	 * @return the schema of the wrapped value
	 */
	 ...
	 * @return the annotations declared on the wrapped type argument
	 */
